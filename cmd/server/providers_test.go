...
func TestSimpleProviders(t *testing.T) {
	...
	articleRepository := provideArticleRepository(nil, querier, func(value postgres.Querier) postgres.Querier { return value })
	require.NotNil(t, articleRepository)
	...
	require.NotNil(t, provideArticleService(articleRepository, userService, provideTagService(querier), articleTagService, favoriteService, followService))
	require.NotNil(t, provideAuthService(querier, cfg))
