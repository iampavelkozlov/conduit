...
FROM golang:1.26.6-alpine@sha256:3889b425f035be855a72fb4755265311293b6d414521f0a519d819df32222d83 AS server-builder
...
COPY --from=server-builder /out/conduit /app/conduit
